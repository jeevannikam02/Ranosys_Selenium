...
public class AapKiAppCreateEducationalApp {
	public static WebDriver driver = null;
	public static List<ObjectStatus> status = new ArrayList<ObjectStatus>();
	public static int rowCount = 0;
	static String fileName = "E:\\SeleniumTestData\\AapKiAppStatus\\AapKiAppCreateEducationalAppStatus.xls";
	...
	public static void executeAapKiAppCreateApp() throws BiffException, IOException {
		Sheet s;
		FileInputStream fi = new FileInputStream("E:\\SeleniumTestData\\AapKiApp\\AapKiAppCreateEducationalApp.xls");
		...
		for (int column = 4; column <= 4; column++) {
			for (int row = 1; row < rowNumbers; row++) {
				...
				try {
					...
					if (TypofInput.equalsIgnoreCase("Switch_Frame")) {
					...
					else if (TypofInput.equalsIgnoreCase("First_Name")) {
						driver.findElements(By.xpath(Fieldname)).get(0).click();
						Thread.sleep(200);
						boolean FirstName = driver.findElement(By.xpath(Fieldname)).isEnabled();
						System.out.println("Submit Button Enabled:" + FirstName);
						continue;
					}

					else if (TypofInput.equalsIgnoreCase("Send_First_Name")) {
						driver.findElement(By.xpath(Fieldname)).clear();
						driver.findElement(By.xpath(Fieldname)).sendKeys(Value);
						continue;
					}

					else if (TypofInput.equalsIgnoreCase("Second_Name")) {
						Thread.sleep(200);
						int size1 = driver.findElements(By.xpath(Fieldname)).size();
						System.out.println("Size is :" + size1);
						boolean LastName = driver.findElements(By.xpath(Fieldname)).get(1).isEnabled();
						System.out.println("Last Name is Enabled (True/False):" + LastName);
						driver.findElements(By.xpath(Fieldname)).get(1).click();
						System.out.println("Clicked");
						continue;
					}

					else if (TypofInput.equalsIgnoreCase("Send_Second_Name")) {
						Thread.sleep(2000);
						driver.findElement(By.xpath(Fieldname)).sendKeys(Value);
						driver.findElement(By.xpath(Fieldname)).clear();
						driver.findElement(By.xpath(Fieldname)).sendKeys(Value);
					...
					else if (TypofInput.equalsIgnoreCase("Switch_Default")) {
						driver.switchTo().defaultContent();
						Thread.sleep(2000);
						System.out.println("Switched to Default Containt");
						continue;
					}
					...
					else if (TypofInput.equalsIgnoreCase("Click_Date")) {
						driver.findElement(By.id(Fieldname)).click();
