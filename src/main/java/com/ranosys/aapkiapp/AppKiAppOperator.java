...
public class AppKiAppOperator {
	public static WebDriver driver = null;
	public static List<ObjectStatus> status = new ArrayList<ObjectStatus>();
	public static int rowCount = 0;
	static String fileName = "E:\\SeleniumTestData\\AapKiAppStatus\\AppKiAppOperatorStatus.xls";
	...
	public static void executeAapKiAppCreateApp() throws BiffException, IOException {
		Sheet s;
		FileInputStream fi = new FileInputStream("E:\\SeleniumTestData\\AapKiApp\\AppKiAppOperator.xls");
			...
			for (int row = 1; row < rowNumbers; row++) {
				...
				try {
					...
					if (TypofInput.equalsIgnoreCase("Select_Color")) {
						...
						driver.findElement(By.xpath(Fieldname)).clear();
						driver.findElement(By.xpath(Fieldname)).sendKeys(Utilities.getMail(2, 0));
						Thread.sleep(500);
						continue;
					}
					...
					else if (TypofInput.equalsIgnoreCase("Check_Contains_Tab")) {
						List<WebElement> containtList = new ArrayList<WebElement>();
						containtList = driver.findElements(By.xpath(Fieldname));
						int size = containtList.size();
						Utilities.takeScrShotOnAsserssion(driver);
						Assert.assertEquals(size, Integer.parseInt(Value));
						System.out.println("Size of list is:" +size);
						System.out.println("Asserssion passed for Contains........");
						continue;
					}
					
					else if (TypofInput.equalsIgnoreCase("Check_Title")) {
						String Title = driver.findElement(By.xpath(Fieldname)).getText();
						Utilities.takeScrShotOnAsserssion(driver);
						...
						Utilities.takeScrShotOnAsserssion(driver);
						Assert.assertEquals(splitArray[1].trim(), "rgb(79, 79, 79) none repeat scroll 0% 0%; opacity");
						System.out.println("Asserssion passed........");
						continue;
					}
						...
						System.out.println("Hi:" + splitArray[1]);
						Utilities.takeScrShotOnAsserssion(driver);
						Assert.assertEquals(splitArray[1].trim(), Value);
						System.out.println("Asserssion passed........");
						continue;
					}
						...
						System.out.println("Hi:" + splitArray[1]);
						Utilities.takeScrShotOnAsserssion(driver);
						Assert.assertEquals(splitArray[1].trim(), "rgb(201, 201, 201);");
						System.out.println("Asserssion passed........");
						continue;
					}
						...
						System.out.println("Hi:" + splitArray[1]);
						Utilities.takeScrShotOnAsserssion(driver);
						Assert.assertEquals(splitArray[2].trim(), "rgb(255, 255, 255);");
						System.out.println("Asserssion passed........");
						continue;
					}
